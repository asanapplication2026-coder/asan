...
import '../../controllers/auth_controller.dart'; // Imports AuthController for email validation
...
class LoginScreen extends StatelessWidget {
    ...
    return CupertinoPageScaffold(
      ...
      child: Stack(
        children: [
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...
                    backgroundColor,
                    backgroundColor,
                    // Merges seamlessly into system background
                  ],
                ),
              ),
            ),
          ...
          Positioned.fill(
            child: Material(
              // Completely eradicates the yellow underline issue
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Extremely tight spacing to lock it to the title
                          ...
                          // Premium spatial gap between inputs
  ...
  Widget _buildEmailField(BuildContext context) {
    return Obx(() {
      final bool isValid = authController.isValidEmail(
        _currentEmail.value.trim(),
      );
  ...
  Widget _buildPasswordRequirementsGrid(BuildContext context) {
    ...
    final inactiveGray = CupertinoColors.secondaryLabel
        .resolveFrom(context)
        ...
        children: [
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              color: isMet
                  ? metColor.withValues(alpha: 0.15)
                  : Colors.transparent,
              border: Border.all(
                color: isMet ? metColor : unmetColor,
                width: 1.5,
            ...
            child: Center(
              child: AnimatedOpacity(
                ...
                child: Icon(CupertinoIcons.checkmark, size: 9, color: metColor),
              ),
            ),
          ),
